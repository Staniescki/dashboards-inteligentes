...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        \Illuminate\Support\Facades\DB::statement("CREATE MATERIALIZED VIEW sales_commission_view AS $query");
    }
    ...
    {
        \Illuminate\Support\Facades\DB::statement("DROP MATERIALIZED VIEW sales_commission_view");
    }
};
